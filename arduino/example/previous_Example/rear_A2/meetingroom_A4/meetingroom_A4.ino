...
//Create a client
ThingClient client_A4("Client_A4_Meetingroom", Serial);
//Create values
CapitalValue humidityValue("Humidity_Meetingroom", HumiditySensor, 0.0, 100.0, 3000);
CapitalValue temperatureValue("Temperature_Meetingroom", TemperatureSensor, 0.0, 100.0, 3000);
CapitalValue dustValue("Dust_Meetingroom", DustSensor, 0.0, 1000.0, 3000);
CapitalValue soundValue("Sound_Meetingroom", SoundSensor, 0.0, 450.0, 2000);// original maximum value is 422.4

void setup() {
// put your setup code here, to run once:

  client_A4.Add(humidityValue);
  client_A4.Add(temperatureValue);
  client_A4.Add(dustValue);
  client_A4.Add(soundValue);
