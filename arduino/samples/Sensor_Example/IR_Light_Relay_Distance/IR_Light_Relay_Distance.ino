...
#define CLIENT_NAME "Arduino_thsvkd"
...
/*
void turn_on_ir(void *pData)
{
  int power = -1, res;
  res = GetIntArgumentByName(pData, ARG_LIGHT_SWITCH, &power);
  if (res == -1)
  {
    return;
  }
...
Value lightValue(LIGHT_VALUE, LightSensor, 0, 2000, 1000);
Value distanceValue(DISTANCE_VALUE, DistanceSensor, 0, 30000, 1000);
